...
SECRET_KEY = 'django-insecure-jy8-gm_i+*h2wv4+kq7v+49d(ec+5z7ka0*%8vly$!cixx-a3('
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_NAME', 'Study-bud'),
        'USER': os.environ.get('POSTGRES_USER', 'postgres'),
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'Mattikere@1605'),
        'HOST': os.environ.get('POSTGRES_HOST', 'localhost'),  # <-- Use env var!
